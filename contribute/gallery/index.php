			...
			<form enctype="multipart/form-data" id="cdmWebAddForm" method="POST" action="/utils/webadd/collection/<?php echo $this->collection;?>">
				    ...
				    <div class="row">
	                    <div class="span7" >
					       ...
					       <div class="control-group">
				                <label>What type of artwork is this? <i>*</i></label>
				                <select name="format" id="format" class="required preview">
				                    <option value=""></option>
				                    <?php
                                        $url = 'https://server15770.contentdm.oclc.org/dmwebservices/index.php?q=dmGetCollectionFieldVocabulary/' . $this->collection . '/format/0/1/json';
                                        $fh = file_get_contents($url);
                                        $json = json_decode($fh);
                                        foreach ($json as $key=>$value){
                                            if ($value != 'telephone directory'){
                            ...
                            <div class="control-group">
                                <label>What are the dimensions of the piece?</label>
                                <input type="text" id="dimensions" name="dimens" value="" class="preview input-xxlarge" placeholder="" />
                            </div>
				            <div class="control-group">
				                <label>When was this piece created? <i>*</i></label>
						    ...
						    <div class="control-group">
						        <label>Describe what the piece is about. What inspired the work? Do you have an interesting story to tell about it? <i>*</i></label>
